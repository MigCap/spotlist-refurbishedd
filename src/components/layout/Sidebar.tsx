...
function Sidebar() {
  ...
  return (
    <>
      <div className='border-gray-900 border-r h-screen hidden p-4 text-gray-500 text-xs sm:max-w-[12rem] sm:min-w-[12rem] md:inline-flex lg:max-w-[15rem] lg:min-w-[12rem] lg:text-sm'>
        <div className=''>
          <img
